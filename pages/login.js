...
export default class extends React.Component {
    ...
    static getInitialProps(context) {
        console.info("Login getInitialProps");
    ...
    render() {
        return (
            <div>
                ...
                <div id="login-area">
                    <div id="login-form">
                        <form action="/login" method="POST" data-ng-submit="ctrl.submit()" autoComplete="off"
                              noValidate="1" className="ng-pristine ng-invalid ng-invalid-required">
