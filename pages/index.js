        ...
        <div className="filtros filters filter-despachos ng-scope" id="filtro-turnos">
          ...
          <div className="campo">
            ...
            >
              ...
              <option value="80019" className="ng-binding ng-scope"> CEMENTO ALBAÑILERIA IRAM 1685 B40 KG </option>
              <option value="80067" className="ng-binding ng-scope"> CEMENTO CPC40 IRAM 50000 B50 KG </option>
              <option value="80027" className="ng-binding ng-scope"> CEMENTO CPF40 IRAM 50000 B50 KG </option>
            </select>
          </div>
            ...
            <div className="checkbox-outer">
              <div className="checkbox-container">
                <input
                  ...
                  onChange={e => {this.setState(prev=>{ return {CIF: !prev.CIF }})}}
                />
                <label htmlFor="CIF" />
              </div>
              <span>CIF</span>
            ...
            <div className="checkbox-outer">
              <div className="checkbox-container">
                <input
                  ...
                  id="FOB"
                  className="ng-pristine ng-untouched ng-valid ng-empty"
                  onChange={e => {this.setState(prev=>{ return {FOB: !prev.FOB }})}}
                />
                <label htmlFor="FOB" />
              </div>
              <span>FOB</span>
